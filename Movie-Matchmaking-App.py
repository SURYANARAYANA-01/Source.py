...
@st.cache_data
def load_movies():
    # Using a publicly available dataset URL as fallback
    try:
        df = pd.read_csv("https://raw.githubusercontent.com/amankharwal/Website-data/master/imdb_top_1000.csv")
    except:
        st.error("Could not load movie data. Using sample data instead.")
        data = {
